...
#     print doppler_positions[0, :, 0].mean()
    ...
    ychunks_heat = heat_energy_x_left[:chunksize*numchunks_heat].reshape((-1, chunksize))
    ...
    ychunks_heat = heat_energy_x_right[:chunksize*numchunks_heat].reshape((-1, chunksize))
    xchunks_heat = time_axis_heat[:chunksize*numchunks_heat].reshape((-1, chunksize))
    ycenters_heat = xchunks_heat.mean(axis=1)
    xcenters_heat = ychunks_heat.mean(axis=1)
